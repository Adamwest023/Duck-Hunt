...
def draw_gun():
    ...
    # using the position to find the geometry of the mouse and gun position
...
def draw_pause():
    global level, pause, menu, total_shots, points, time_passed, time_remaining, clicked, new_coords
